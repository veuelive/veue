...
class User < ApplicationRecord
  ...
  has_many :streamers, class_name: :Follow, foreign_key: :streamer_user_id, dependent: :destroy, inverse_of: :streamer
  has_many :followers, class_name: :Follow, foreign_key: :follower_user_id, dependent: :destroy, inverse_of: :follower
