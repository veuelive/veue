  ...
  })()(
    {
                ...
                value: function filter(z) {
                  ...
                  if (isNaN(this.x)) {
                    ...
                    var K =
                      predCov *
                      this.C *
                      (1 / (this.C * predCov * this.C + this.Q)); // Correction
      ...
      5: [
        function (require, module, exports) {
          ...
          function getCommonCapabilities(
            ...
            var findCodecByPayloadType = function findCodecByPayloadType(
              pt,
              codecs
            ) {
              pt = parseInt(pt, 10);
            ...
            var rtxCapabilityMatches = function rtxCapabilityMatches(
              lRtx,
              rRtx,
              lCodecs,
              rCodecs
            ...
            RTCPeerConnection.prototype.setRemoteDescription = function (
              ...
              sections.forEach(function (mediaSection, sdpMLineIndex) {
                ...
                var mid =
                  ...
                  SDPUtils.generateIdentifier(); // Reject datachannels which are not implemented yet.
      ...
      */
          ...
          function v1(options, buf, offset) {
            ...
            var msecs =
              options.msecs !== undefined
                ? options.msecs
                : new Date().getTime(); // Per 4.2.1.2, use count of uuid's generated during the current clock
      ...
      12: [
        ...
        {
          "./chrome/chrome_shim": 13,
          "./common_shim": 16,
          "./edge/edge_shim": 17,
          "./firefox/firefox_shim": 21,
          "./safari/safari_shim": 24,
          "./utils": 25,
        },
      ],
      13: [
        function (require, module, exports) {
          ...
          function shimPeerConnection(window) {
            ...
            var addIceCandidateNullSupported =
              window.RTCPeerConnection.prototype.addIceCandidate.length === 0; // shim implicit creation of RTCSessionDescription/RTCIceCandidate
        ...
        { "../utils.js": 25, "./getdisplaymedia": 14, "./getusermedia": 15 },
      ],
      14: [
        function (require, module, exports) {
          /*
      ...
      21: [
        ...
        { "../utils": 25, "./getdisplaymedia": 22, "./getusermedia": 23 },
      ],
      22: [
        function (require, module, exports) {
          /*
      ...
      27: [
        function (require, module, exports) {
          ...
          var browserDetails = require("webrtc-adapter")["default"]
            .browserDetails;
          ...
          var init = function init(options) {
            if (!initialized) {
              ...
              disableConnectionQualityCalculation =
                options.disableConnectionQualityCalculation;
              ...
              if (
                ...
                var webRtcConf = {
                  constraints:
                    options.constraints || getDefaultMediaConstraints(),
                ...
                if (
                  ...
                  AdapterJS.webRTCReady(function (isUsingPlugin) {
                    ...
                    if (options.mediaProvidersReadyCallback) {
                      options.mediaProvidersReadyCallback(
                        Object.keys(MediaProvider)
                      );
                    }
                  });
                }
              ...
              if (
                ...
                var flashConf = {
                  ...
                  flashMediaProviderSwfLocation:
                    options.flashMediaProviderSwfLocation,
                  logger: logger,
                };
              ...
              if (getMediaProviders().length == 0) {
                ...
                if (
                  MediaProvider.hasOwnProperty(options.preferredMediaProvider)
                ) {
                  if (
                    getMediaProviders()[0] != options.preferredMediaProvider
                  ) {
                    // Just reorder media provider list
                    var _MediaProvider = {};
                    _MediaProvider[options.preferredMediaProvider] =
                      MediaProvider[options.preferredMediaProvider];
                  ...
                  logger.warn(
                    LOG_PREFIX,
                    "Preferred media provider is not available."
                  );
                }
              }
              ...
              if (
                options.preferredMediaProviders &&
                options.preferredMediaProviders.length > 0
              ) {
          ...
          var getMediaDevices = function getMediaDevices(
            ...
            return MediaProvider[mediaProvider].listDevices(
              labels,
              kind,
              deviceConstraints
            );
          ...
          var releaseLocalMedia = function releaseLocalMedia(
            display,
            mediaProvider
          ) {
            if (!initialized) {
          ...
          var createSession = function createSession(options) {
            ...
            function requestURL(url) {
              ...
              request.ontimeout = function () {
                logger.warn(
                  LOG_PREFIX,
                  "Timeout during geting url from balancer!"
                );
                createWS(urlServer);
              };
              ...
              request.error = function () {
                logger.warn(
                  LOG_PREFIX,
                  "Error during geting url from balancer!"
                );
                createWS(urlServer);
              };
              ...
              request.onload = function (e) {
                if (request.status == 200 && request.readyState == 4) {
                  ...
                  logger.debug(
                    LOG_PREFIX,
                    "Got url from load balancer " + result.server
                  );
                  createWS(urlServer);
                }
              };
                ...
                switch (data.message) {
                  ...
                  case "setRemoteSDP":
                    ...
                    if (streamRefreshHandlers[mediaSessionId]) {
                      ...
                      logger.info(
                        LOG_PREFIX,
                        "Media not found, id " + mediaSessionId
                      );
                    }
                  ...
                  case "notifyIncomingCall":
                    if (callRefreshHandlers[obj.callId]) {
                      logger.error(
                        LOG_PREFIX,
                        "Call already exists, id " + obj.callId
                      );
                    }
                  ...
                  case "notifySessionDebugEvent":
                    logger.info(
                      LOG_PREFIX,
                      "Session debug status " + obj.status
                    );
                  ...
                  case "availableStream":
                    ...
                    if (streamRefreshHandlers[availableStream.mediaSessionId]) {
                      streamRefreshHandlers[availableStream.mediaSessionId](
                        availableStream
                      );
                    }
            ...
            var createCall = function createCall(options) {
              ...
              var mediaProvider =
                options.mediaProvider || getMediaProviders()[0];
              var mediaConnection;
              ...
              if (options.disableConstraintsNormalization) {
                var disableConstraintsNormalization =
                  options.disableConstraintsNormalization;
              }

              var audioOutputId;
              var audioProperty = getConstraintsProperty(
                constraints,
                "audio",
                undefined
              );
              ...
              if (_typeof(audioProperty) === "object") {
                audioOutputId = getConstraintsProperty(
                  audioProperty,
                  "outputId",
                  0
                );
              ...
              var receiveAudio =
                typeof options.receiveAudio !== "undefined"
                  ? options.receiveAudio
                  : true;
              var receiveVideo =
                typeof options.receiveVideo !== "undefined"
              ...
              callRefreshHandlers[id_] = function (
                callInfo,
                sdp,
                codec,
                transfer
                ...
                if (
                  !mediaConnection &&
                  Object.keys(mediaConnections).length != 0
                ) {
                ...
                if (sdp && sdp !== "") {
                  ...
                  mediaConnection
                    .setRemoteSdp(sdp, hasTransferredCall, id_)
                    .then(function () {});
                  return;
                }
              ...
              var answer = function answer(answerOptions) {
                if (
                  status_ !== CALL_STATUS.NEW &&
                  status_ !== CALL_STATUS.RING
                ) {
                  throw new Error("Invalid call state");
                }
                ...
                constraints =
                  answerOptions.constraints || getDefaultMediaConstraints();
                status_ = CALL_STATUS.PENDING;
                var sdp;
            ...
            var createStream = function createStream(options) {
              ...
              var mediaConnectionConstraints =
                options.mediaConnectionConstraints; // Receive media
              ...
              if (typeof audioProperty === "boolean") {
                ...
                var _stereo = getConstraintsProperty(
                  audioProperty,
                  "stereo",
                  0
                );

                var _bitrate = getConstraintsProperty(
                  audioProperty,
                  "bitrate",
                  0
                );
                ...
                var _codecOptions = "";
                if (_bitrate)
                  _codecOptions += "maxaveragebitrate=" + _bitrate + ";";
              ...
              var receiveVideo;
              var videoProperty = getConstraintsProperty(
                constraints,
                "video",
                undefined
              );
              ...
              var bitrate = getConstraintsProperty(
                constraints,
                "video.bitrate",
                0
              );
              var minBitrate = getConstraintsProperty(
                constraints,
                "video.minBitrate",
                0
              );
              var maxBitrate = getConstraintsProperty(
                constraints,
                "video.maxBitrate",
                0
              ); // Quality

              var quality = getConstraintsProperty(
                constraints,
                "video.quality",
                0
              );
              ...
              var playWidth =
                typeof options.playWidth !== "undefined"
                  ? options.playWidth
                  : getConstraintsProperty(constraints, "video.width", 0);
              var playHeight =
                typeof options.playHeight !== "undefined"
                  ? options.playHeight
              ...
              streamRefreshHandlers[id_] = function (streamInfo, sdp) {
                ...
                if (sdp && sdp !== "") {
                  var _sdp = sdp;
                  if (_codecOptions)
                    _sdp = util.SDP.writeFmtp(sdp, _codecOptions, "opus");
              ...
              var detectConnectionQuality = function detectConnectionQuality(
                event,
                streamInfo
              ) {
                ...
                mediaConnection.getStats(function (stats) {
                  ...
                  var videoRateDifference =
                    Math.abs(
                      (serverFiltered - clientFiltered) /
                        ((serverFiltered + clientFiltered) / 2)
                    ) * 100;
                  var currentQuality;
                  ...
                  if (
                    ...
                    if (
                      videoRateDifference >
                      LOW_VIDEO_RATE_BAD_QUALITY_PERCENT_DIFFERENCE
                    ) {
                    ...
                    if (
                      videoRateDifference >
                      VIDEO_RATE_BAD_QUALITY_PERCENT_DIFFERENCE
                    ) {
                      currentQuality = CONNECTION_QUALITY.BAD;
                    } else if (
                      videoRateDifference >
                      VIDEO_RATE_GOOD_QUALITY_PERCENT_DIFFERENCE
                    ) {
                  ...
                  .createConnection(
                    {
                      ...
                      flashShowFullScreenButton:
                        options.flashShowFullScreenButton || false,
                      connectionConfig: mediaOptions,
                  ...
                  .then(function () {
                    ...
                    MediaProvider[mediaProvider]
                      .createConnection({
                        ...
                        connectionConstraints: mediaConnectionConstraints,
                        customStream:
                          constraints && constraints.customStream
              ...
              var stop = function stop() {
                ...
                if (status_ == STREAM_STATUS.NEW) {
                  ...
                  logger.warn(
                    LOG_PREFIX,
                    "Stopping stream before server response " + id_
                  );
                  setTimeout(stop, 200);
                  return;
              ...
              var videoResolution = function videoResolution() {
                if (!published_) {
                  ...
                  throw new Error(
                    "This function available only on playing stream"
                  );
                }
              };
              /**
              ...
              var fullScreen = function fullScreen() {
                if (published()) {
                  logger.warn(
                    LOG_PREFIX,
                    "Full screen is allowed only for played streams"
                  );
                } else {
        ...
        {
          "./constants": 26,
          "./flash-media-provider": 1,
          "./media-source-media-provider": 1,
          "./room-module": 28,
          "./temasys-media-provider": 1,
          "./util": 29,
          "./webrtc-media-provider": 30,
          "./websocket-media-provider": 1,
          kalmanjs: 2,
          "promise-polyfill": 4,
          "uuid/v1": 10,
          "webrtc-adapter": 11,
        ...
        function (require, module, exports) {
          ...
          var appSession = function appSession(options) {
            ...
            var session = Flashphoner.createSession({
              ...
              appKey:
                options.appKey && options.appKey.length != 0
                  ? options.appKey
                  : ROOM_REST_APP,
              custom: {
            ...
            var join = function join(options) {
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  function cleanUp() {
                    ...
                    for (var i = 0; i < streams.length; i++) {
                      if (
                        streams[i].name().indexOf(name_ + "-" + username_) !==
                          -1 &&
              ...
              var publish = function publish(options) {
                ...
                options.cacheLocalResources =
                  typeof options.cacheLocalResources === "boolean"
                    ? options.cacheLocalResources
                    : true;
                options.custom = {
                  name: name_,
      ...
      29: [
        function (require, module, exports) {
          ...
          module.exports = {
             ...
             */
            copyObjectPropsToAnotherObject: function copyObjectPropsToAnotherObject(
              src,
              dst
            ) {
              for (var prop in src) {
            ...
            processRtcStatsReport: function processRtcStatsReport(
              browser,
              report
            ) {
              var result = {};
            ...
            SDP: {
              ...
              writeFmtp: function writeFmtp(sdp, param, codec) {
                ...
                for (i = 0; i < sdpArray.length; i++) {
                  if (
                    sdpArray[i].search(codec) != -1 &&
                    sdpArray[i].indexOf("a=rtpmap") == 0
                  ) {
                    sdpArray[i] +=
                      "\na=fmtp:" +
                      sdpArray[i].match(/[0-9]+/)[0] +
                      " " +
                      param +
                      "\r";
                  }
            ...
            getCurrentCodecAndSampleRate: function getCurrentCodecAndSampleRate(
              sdp,
              mediaType
            ) {
              var rows = sdp.split("\n");
      ...
      30: [
        function (require, module, exports) {
          ...
          var createConnection = function createConnection(options) {
            return new Promise(function (resolve, reject) {
              ...
              if (bidirectional) {
                ...
                if (
                  options.audioOutputId &&
                  typeof remoteVideo.setSinkId !== "undefined"
                ) {
              ...
              connection.onicecandidate = function (event) {
                if (event.candidate != null) {
                  logger.debug(
                    LOG_PREFIX,
                    "Added icecandidate: " + event.candidate.candidate
                  );
                }
              };
              ...
              var close = function close(cacheCamera) {
                ...
                if (
                  localVideo &&
                  !getCacheInstance(localDisplay || display) &&
                  cacheCamera
                ) {
                ...
                return new Promise(function (resolve, reject) {
                  ...
                  connection.createAnswer().then(function (answer) {
                    connection.setLocalDescription(answer).then(function () {
                      resolve(
                        util.stripCodecs(answer.sdp, options.stripCodecs)
                      );
                    });
                  });
                });
                          ...
                          if (!report.isRemote) {
                            if (report.type == "outbound-rtp") {
                              ...
                              if (report.mediaType == "video") {
                                var vSettings = localVideo.srcObject
                                  .getVideoTracks()[0]
                                  .getSettings();
                                result.outboundStream[report.mediaType].height =
                                  vSettings.height;
                                result.outboundStream[report.mediaType].width =
                                  vSettings.width;
                              }
                              ...
                              if (
                                ...
                                result.inboundStream[report.mediaType].height =
                                  remoteVideo.videoHeight;
                                result.inboundStream[report.mediaType].width =
              ...
              function fillStatObject(obj, report) {
                ...
                var description =
                  connection.currentRemoteDescription != undefined
                    ? connection.currentRemoteDescription
                    : connection.remoteDescription;
                var codec = util.getCurrentCodecAndSampleRate(
                  description.sdp,
                  mediaType
                );
                    ...
                    connection.getSenders().forEach(function (sender) {
                      ...
                      var cam =
                        typeof deviceId !== "undefined"
                          ? deviceId
                          : videoCams[switchCamCount]; //use the settings that were set during connection initiation
                  ...
                  if (
                    ...
                    connection.getSenders().forEach(function (sender) {
                      ...
                      var mic =
                        typeof deviceId !== "undefined"
                          ? deviceId
                          : mics[switchMicCount]; //use the settings that were set during connection initiation
                  ...
                  if (!screenShare) {
                    ...
                    if (window.chrome && woExtension) {
                      getScreenDeviceIdWoExtension(clonedConstraints).then(
                        function (screenSharingConstraints) {
                          navigator.mediaDevices
                    ...
                    getScreenDeviceId(clonedConstraints)
                      .then(function (screenSharingConstraints) {
                        clonedConstraints.sourceId =
                          screenSharingConstraints.sourceId;
              ...
              var processScreenStream = function processScreenStream(
                stream,
                resolve
              ) {
                connection.getSenders().forEach(function (sender) {
          ...
          var getMediaAccess = function getMediaAccess(
            ...
            return new Promise(function (resolve, reject) {
              ...
              if (
                ...
                JSON.stringify(display.mediaTrackConstraints) ==
              ...
              if (
                ...
                if (window.chrome && constraints.video.withoutExtension) {
                  getScreenDeviceIdWoExtension(constraints).then(function (
                    screenSharingConstraints
                  ) {
                    getScreenAccessWoExtension(
                      screenSharingConstraints,
                      constraints.audio
                    );
                  });
                ...
                getScreenDeviceId(constraints).then(function (
                  screenSharingConstraints
                ) {
                  //copy constraints
              ...
              function getScreenAccessWoExtension(
                constraints,
              ...
              if (
                ...
                navigator.getUserMedia(
                  ...
                  function (stream) {
                    logger.info(
                      LOG_PREFIX,
                      "Got audio stream, add it to video stream"
                    );
                      ...
                      function (response) {
                        if (response.error) {
                          ...
                          if (response.systemSoundAccess) {
                            ...
                            logger.error(
                              LOG_PREFIX,
                              "System sound: access is denied by the user"
                            );
                          }
                        }
                      }
          ...
          var setScreenResolution = function setScreenResolution(
            video,
            stream,
            constraints
          ) {
          ...
          var getScreenDeviceIdWoExtension = function getScreenDeviceIdWoExtension(
            constraints
          ) {
            return new Promise(function (resolve, reject) {
                ...
                chrome.runtime.sendMessage(
                  ...
                  function (response) {
                    ...
                    if (response) {
                      ...
                      reject(
                        new Error("Screen sharing extension is not available")
                      );
                    }
                  }
                );
            ...
            var getConstraints = function getConstraints(devices) {
              ...
              for (var i = 0; i < devices.length; i++) {
                ...
                if (
                  ...
                  device.kind.indexOf("video" + kind) === 0 &&
                  ...
                  if (labels) {
                    ...
                    navigator.getUserMedia(
                      ...
                      function (stream) {
                        navigator.mediaDevices
                          .enumerateDevices()
                          .then(function (devicesWithLabales) {
              ...
              if (_typeof(constraints.video) === "object") {
                ...
                if (browserDetails.browser == "safari") {
                  if (!width || !height) {
                    ...
                    _typeof(width) !== "object" ||
                    _typeof(height) !== "object"
                  ) {
                    constraints.video.width = {
                      min: width,
                      max: width,
          ...
          var playFirstVideo = function playFirstVideo(display, isLocal, src) {
            return new Promise(function (resolve, reject) {
              if (!getCacheInstance(display)) {
                ...
                video.id =
                  uuid_v1() +
                  (isLocal ? LOCAL_CACHED_VIDEO : REMOTE_CACHED_VIDEO); //in WCS-1560 we removed video.play() call, because it triggers the “Unhandled Promise Rejection” exception in iOS Safari
          ...
          module.exports = {
            ...
            configure: function configure(configuration) {
              ...
              createMicGainNode =
                typeof configuration.createMicGainNode !== "undefined"
