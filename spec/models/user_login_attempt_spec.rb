...
RSpec.describe UserLoginAttempt, type: :model do
  ...
  context "creation" do
    ...
    it "should normalize the phone number" do
      ula = UserLoginAttempt.create!(phone_number: "+1 (904) 384-0459")
  ...
  context "no user account" do
    it "should fail with a bad code" do
      ula = UserLoginAttempt.create!(phone_number: "+19043840459")
      expect(ula).to be_valid
  ...
  describe "Existing users" do
    ...
    it "should use the existing user!" do
      ula = UserLoginAttempt.create!(user: user)
      expect(ula).to be_valid
