  ...
  describe "UTC times" do
    describe "one weekly show" do
      it "should work in utc with one weekly show scheduled during this week" do
        shows = Schedulatron.upcoming_shows({days_of_the_week: ["Sunday"], type: "weekly", timezone: "UTC", minute_of_day: 930})
      ...
      it "should roll to the next week if the day is in the past this week" do
        ...
        shows = Schedulatron.upcoming_shows({days_of_the_week: ["Tuesday"], type: "weekly", timezone: "UTC", minute_of_day: 930})
        expect(shows.count).to eq(1)
      ...
      it "should go to next week after the time" do
        ...
        shows = Schedulatron.upcoming_shows({days_of_the_week: ["Thursday"], type: "weekly", timezone: "UTC", minute_of_day: 900})
        expect(shows.count).to eq(1)
    ...
    describe "two shows a week" do
      it "should schedule both shows, one in this week, and one rolling into the next" do
        shows = Schedulatron.upcoming_shows({days_of_the_week: ["Sunday", "Wednesday"], type: "weekly", timezone: "UTC", minute_of_day: 930})
