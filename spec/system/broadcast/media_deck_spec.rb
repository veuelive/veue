...
describe "Broadcaster Media Deck" do
  ...
  describe "screen share" do
    it "starts sharing screen" do
...
|,
  ...
  describe "Broadcaster Media Deck Webcam Share" do
    it "attaches camera" do
      ...
      click_on("Attach Another Camera")

      expect(page).to have_css(".MediaDeck__webcam-share")

      find(".MediaDeck__webcam-share--item").click
      expect(page).to have_content("Stop Camera Stream")
    end
  end
end
